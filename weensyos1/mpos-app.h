...
//  *
//  *	creates a new process in a thread-like way, copying the registers from parent
//  *  but with empty stack. And the child process starts by executing the function
//  *  of start_function 
//  *  return value is the same with sys_fork()
//  ****************************************************************************
// static inline pid_t
// sys_newthread(void (*start_function)(void)){
// 	pid_t retpid;
...
//  *	sys_kill(pid_t pid)
//  *
//  *	returns flag of success or failure
//  ****************************************************************************
// static inline int
// sys_kill(pid_t pid){
// 	int ret;
